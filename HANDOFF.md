...
./run_tests.sh        # 1,232 checks measured 2026-08-23; 8-75 min depending on load (it runs real OCR)
```
...
suite is at **1,232 checks** (measured 2026-08-23) and it **needs nothing installed
