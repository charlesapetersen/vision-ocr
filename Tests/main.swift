...
do {
    ...
    if JBIG2.isAvailable {
        ...
        // Measured over 86 corpus pages read at 1:1 (C26 sub-step 4 plus C28's
        // four sub-steps of 8 + 24 + 20 + 21, which is every page the shipped bar
        // still shrinks), the ink outside the recognised words
        // was content on 24 of them, 18 of those typeset. These checks and R50's
