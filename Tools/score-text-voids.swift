...
// `score-run-width`'s pattern — eight of the NINE other Swift tools here that have one,
// `score-annot-marks` having joined them on 2026-08-26 and `score-reading-order` the same day —
...
// ways: seven others carried one on 2026-08-25 and **nine do since
// `score-annot-marks` and `score-reading-order` landed on 2026-08-26** — ten tools in all —
// **all but one run it unconditionally**, `score-shape-term` is the
